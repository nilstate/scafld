...
import (
	...
	submitmcp "github.com/nilstate/scafld/v2/internal/adapters/mcp/hardensubmit"
)

// ErrInvalid wraps invalid hidden-command arguments.
var ErrInvalid = errors.New("invalid harden-submit-stdio arguments")

// Handler returns a CLI-compatible command handler for harden-submit-stdio.
...
// Run starts the harden submission MCP stdio server.
