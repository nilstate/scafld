...
// provider, model, session_id, output_format, normalizations, and event_summary
// are filled by scafld after the provider returns and are intentionally not part
// of this schema.
