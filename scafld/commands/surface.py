...
COMMAND_SPECS = (
    ...
    CommandSpec(
        ...
        (
            ...
            ArgumentSpec(("--command",), {"dest": "slim_command", "help": "Acceptance command for the slim default criterion"}),
            ArgumentSpec(("--files",), {"dest": "slim_files", "help": "Comma-separated file paths the slim spec touches"}),
