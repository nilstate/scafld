...
The approval gate is the human oversight boundary. During execution, the agent operates autonomously through all phases, pausing only when blocked or deviating from the spec.
